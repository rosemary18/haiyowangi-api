...
const ImageUploader = multer({ storage: imgStorage, limits: { fileSize: 1 * 1024 * 1024 }, fileFilter: imageFileFilter });
const FileUploader = multer({ storage: fileStorage, limits: { fileSize: 1 * 1024 * 1024 } });
